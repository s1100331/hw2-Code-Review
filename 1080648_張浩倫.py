...
class Parent:
    def __init__(self, name, life, x, y, imgfile, tagname, classname="", attacck_mode=""):
        self.name = name
...
class Warrior(Parent):
    def __init__(self, name, life, x, y, imgfile, tagname, classname="", attacck_mode=""):
        super().__init__(name, life, x, y, imgfile, tagname, classname, attacck_mode)
...
character0 = Warrior("Alex", 200, 200, 280, "Warrior_0.png", "LC")
character1 = Magician("Bob", 160, 600, 280, "Magician_0.png", "RC")

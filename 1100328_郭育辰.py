...
"""Created on Tue Mar 15 14:11:25 2022
...
class role:
    def __init__(self, name, life, x, y, imgfile, tagname, classname, attack_mode):
        self.name = name
...
class Warrior(role):
    def __init__(self, name, life, x, y, imgfile, tagname, classname, attack_mode):
        super().__init__(name,life,x,y,imgfile,tagname, classname, attack_mode)
...
character0 = Warrior("Alex", 200, 200, 280, "Warrior_0.jpg", "LC", 'Warrior', 'sword attack')
character1 = Magician("Bob", 160, 600, 280, "Magician_0.jpg", "RC", 'Magician', 'magic attack')
...
btn_left = tkinter.Button(text=character0.attack_mode+" A",command=click_left)
btn_left.place(x=160, y=560)
btn_right = tkinter.Button(text="B "+character1.attack_mode,command=click_right)

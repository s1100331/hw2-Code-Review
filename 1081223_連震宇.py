...
class Character:
    def __init__(self, name,  life, x, y, imgfile, tagname, classname="", attack_mode=""):
        self.name = name
        self.classname = classname  # 需要給予初始值
        self.life = life
        self.lmax = life
        self.x = x
        self.y = y
        ...
        self.attack_mode = attack_mode  # 需要給予初始值
    ...
    def attack(self):  # 原本sword/magic_attack
        dir = 1
        if self.x >= 400:
            dir = -1
...
character0 = Warrior("Alex", 200, 200, 280,
                     "Warrior_0.png", "LC")  # webp檔無法讀取改用png檔
character1 = Magician("Bob", 160, 600, 280,
                      "Magician_0.png", "RC")  # webp檔無法讀取改用png檔
